<?php
    ...
    function obtenerMovimientosPorCentro($idCentro) {
        $url = BASE_URL.'Backend/MovimientosPorOficina.php?idCentro='.$idCentro;
        ...
        {
            throw new Exception('Error en la solicitud: Codigo HTTP: '.$httpCode);
        }
    }
?>